                                ...
                                <tr>
                                    <td>
                                        <table align="center" border="0" cellpadding="0" cellspacing="0"
                                            ...
                                            style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #bee0d7; color: #000000; width: 680px;"
                                            width="680">
                                            <tbody>
                                                <tr>
                                                                ...
                                                                <td class="pad"
                                                                    ...
                                                                    <div align="left" class="alignment"
                                                                        style="line-height:10px"><img
                                                                            src="https://github.com/Glya-Corporation/galery-e/blob/main/alpha.png?raw=true"
                                    ...
                                    <td>
                                        <table align="center" border="0" cellpadding="0" cellspacing="0"
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="column column-1"
                                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top; padding-top: 20px; padding-bottom: 30px; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;"
                                                        width="100%">
                                                        <table border="0" cellpadding="10" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                <td class="pad">
                                                                    <div
                                                                        style="color:#000000;font-size:34px;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;font-weight:700;line-height:120%;text-align:center;direction:ltr;letter-spacing:0px;mso-line-height-alt:40.8px;">
                                                                        <p style="margin: 0;">${data.codeVerify}</p>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class=""
                                                                            ...
                                                                            <p
                                                                                ...
                                                                                <span style="font-size:42px;">With this code
                                                                                    you can verify your profile of the
                                                                                    Question.</span></p>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                ...
                                                                <td class="pad"
                                                                    ...
                                                                    <div style="font-family: sans-serif">
                                                                        <div class=""
                                                                            ...
                                                                            <p
                                                                                style="margin: 0; text-align: left; font-size: 16px; mso-line-height-alt: 24px;">
                                                                                Thaks! we recibed your registration on our
                                                                                website and has been seccessful, now go
                                                                                running and verify your user.</p>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <table align="center" border="0" cellpadding="0" cellspacing="0"
                                            class="row-content stack" role="presentation"
                                            style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #464646; color: #000000; width: 680px;"
                                            width="680">
                                            <tbody>
                                                <tr>
                                                    <td class="column column-1"
                                                                    ...
                                                                    <div style="font-family: sans-serif">
                                                                        <div class=""
                                                                            ...
                                                                            <p
                                                                                ...
                                                                                <span style="font-size:12px;">Cuenca, ECU. && Buenos Aires ARG.</span></p>
                                                                            <p
                                                                                style="margin: 0; font-size: 12px; text-align: center; mso-line-height-alt: 18px;">
                                                                                <span
                                                                                    style="font-size:12px;">corporationglya@gmail.com
                                                                                </span></p>
                                                                            <p
                                                                                style="margin: 0; font-size: 12px; text-align: center; mso-line-height-alt: 18px;">
                                                                                <span style="font-size:12px;">(+593) 97 901 0717</span></p>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                                ...
                                                                <td class="pad">
                                                                    <div style="font-family: sans-serif">
                                                                        <div class=""
                                                                            ...
                                                                            <p
                                                                                style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 16.8px;">
                                                                                <span style="font-size:12px;">2023 © All
